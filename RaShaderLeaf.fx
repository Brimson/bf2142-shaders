...
)
{
    ...
    Out.tex1 = vec3(0,0,0);
        ...
        Out.tex1 = CEXP(OverGrowthAmbient.rgb)/2;
...
float4 basicPixelShader_nomask(VS_OUTPUT input) : COLOR
{
    // Sampler[1] = (DiffuseMapSampler);
    float4 diffuseMap = tex2D(DiffuseMapSampler, input.Tex0);
    float4 output; // r0
    #ifdef _POINTLIGHT_
        output.rgb = input.Color;   // add r0.rgb, v0, v0
        ouput.a = input.Color.a;    // +mov r0.a, v0.a
        output *= diffuseMap * 4.0; // mul_x4 r0, r1, r0
    #else
        output = diffuseMap * input.Color * 4.0; // mul_x4 r0, r1, v0
    #endif
    ...
    pass P0
    {
        vertexShader = compile vs_2_a basicVertexShader();
            ...
            pixelShader = compile ps_2_0 basicPixelShader();
                ...
                pixelShader	= compile ps_2_0 basicPixelShader();
            #else
                PixelShader = compile ps_2_0 basicPixelShader_nomask();
            #endif
        #endif
