...
float4 psDx9_DT(VS2PS_DT_Dx9 indata) : COLOR
{
    ...
    // return lerp(1.5 * detailcontrib, detailcontrib, indata.ColorAndFadeLerp.w);
}
...
VS2PS_DT_Dx9 vsDx9_DT(APP2VS_DT_Dx9 indata)
{
    ...
    outdata.Tex0And1.zw = indata.TexCoord0 * 32.0;

    outdata.ColorAndFadeLerp.w = (-50.0 + length(wPos - vCamerapos)) / 140.0;
