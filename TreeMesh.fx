...
//float4x3 mOneBoneSkinning[52]: matONEBONESKINNING; //: register(vs_1_1, c15);
...
float4 specColor : Specular = {1.0f, 1.0f, 1.0f, 1.0f};
...
)
{
	...
	float3 matsLightDir = float3(0.35f, 0.8f, -0.2f);
...
)
{
	OUT_vsBumpSpecularHemiAndSunPV Out = (OUT_vsBumpSpecularHemiAndSunPV)0;
   	...
   	//vec4 Constants = float4(0.75, 0.75, 0.55, 1.0);
	...
	mat3x3 TanBasis = mat3x3( input.Tan.xyz, 
						binormal, 
						input.Normal.xyz);
