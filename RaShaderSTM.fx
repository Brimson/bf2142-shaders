...
vsStaticMesh(VS_IN indata)
{
    ...
    #else
        Out.Interpolated[__WORLDNORMAL_INTER].xyz = unpackedNormal;
    #endif
    ...
    vec4 FinalColor;
        ...
        return FinalColor;
            ...
            vec3 diffuse = getLightmap(indata);
                ...
                #else
                    diffuse.g *= getShadowFactorLow(ShadowMapSampler, indata.Interpolated[__TEXSHADOW_INTER], 1);
                #endif
            #endif
            ...
            vec3 lightmap = getLightmap(indata);
                ...
                #else
                    lightmap.g *= getShadowFactorLow(ShadowMapSampler, indata.Interpolated[__TEXSHADOW_INTER], 1);
                #endif
            #endif
...
psStaticMesh(VS_OUT indata) : COLOR
{
    ...
    vec4 FinalColor = vec4(0.0, 0.0, 0.0, 0.0);
        ...
        vec4 directionalLightFinalColor;
            ...
            directionalLightFinalColor = getCompositeDiffuse(indata, 0.0, gloss);
...
technique defaultTechnique
{
    pass P0
    {
        ...
        pixelShader  = compile PSMODEL psStaticMesh();
...
technique Glowing
{
    ...
    {
        vertexShader = compile vs_2_0 vsStaticMesh();
        pixelShader  = compile PSMODEL psGlow();
