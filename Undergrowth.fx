	...
	uniform bool shadowmapEnable)
{
	...
	outdata.Pos = mul(pos, worldViewProj);
 	outdata.Tex0.xy = indata.TexCoord / 32767.0;
...
>
{
	pass Normal
	{
		...
		PixelShader			= compile ps_1_4 PShader(false, false, sampler0, sampler1, sampler2);
	}
}
...
>
{
	pass Normal
	{
		...
		PixelShader			= compile ps_1_4 PShader(true, false, sampler0, sampler1, sampler2);
	}
}
...
>
{
	pass Normal
	{
		...
		PixelShader			= compile ps_1_4 PShader_Simple(false, false, sampler0);
	}
}
...
>
{
	pass Normal
	{
		...
		PixelShader			= compile ps_1_4 PShader_Simple(true, false, sampler0);
	}
}
...
>
{
	pass Normal
	{
		...
		PixelShader			= compile ps_1_4 PShader_ZOnly(sampler0);
	}
}
